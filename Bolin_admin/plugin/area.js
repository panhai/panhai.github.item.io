jQuery.fn.areaSelector = function(argument) {
  ...
  $('#' + contentId + ' .area_menu ul li').on('click', function() {
    ...
    $('#' + contentId + ' .area_data_content div:nth-child(' + thisIndex + ')').addClass('isBlock').siblings().removeClass(
      'isBlock');
  })
  ...
  function createProvince() {
    ...
    for (var i = 0; i < areaData.length; i++) {
      ...
      switch (letter) {
        ...
        case "F":
        case "G":
          provinceDomPartOne += '<li><a>' + areaData[i].region.name + '<input value=' + areaData[i].region.code +
        ...
        case "M":
        case "N":
          provinceDomPartTwo += '<li><a>' + areaData[i].region.name + '<input value=' + areaData[i].region.code +
            ' style="display:none"></a></li>';
          break;
        case "O":
        case "P":
        ...
        case "T":
        case "U":
          provinceDomPartThree += '<li><a>' + areaData[i].region.name + '<input value=' + areaData[i].region.code +
            ' style="display:none"></a></li>';
          break;
        case "V":
        case "W":
        ...
        case "Y":
        case "Z":
          provinceDomPartFour += '<li><a>' + areaData[i].region.name + '<input value=' + areaData[i].region.code +
            ' style="display:none"></a></li>';
          break;
      }
    }
      ...
      if (areaData[j].region.code == regionCode) {
        for (var k = 0; k < areaData[j].region.state.length; k++) {
          ...
          switch (letter) {
            ...
            case "F":
            case "G":
              regionDomPartOne += '<li><a>' + areaData[j].region.state[k].name + '<input value="' + areaData[j].region
                .state[k].code + '" style="display:none"></a></li>';
              break;
            case "H":
            case "I":
            case "J":
            ...
            case "M":
            case "N":
              regionDomPartTwo += '<li><a>' + areaData[j].region.state[k].name + '<input value="' + areaData[j].region
                .state[k].code + '" style="display:none"></a></li>';
              break;
            case "O":
            case "P":
            ...
            case "T":
            case "U":
              regionDomPartThree += '<li><a>' + areaData[j].region.state[k].name + '<input value="' + areaData[j].region
                .state[k].code + '" style="display:none"></a></li>';
              break;
            case "V":
            case "W":
            ...
            case "Y":
            case "Z":
              regionDomPartFour += '<li><a>' + areaData[j].region.state[k].name + '<input value="' + areaData[j].region
                .state[k].code + '" style="display:none"></a></li>';
              break;
          }
        }
          ...
          if (areaData[j].region.state[k].code == cityCode) {
            for (var l = 0; l < areaData[j].region.state[k].city.length; l++) {
              ...
              switch (letter) {
                ...
                case "F":
                case "G":
                  cityDomPartOne += '<li><a>' + areaData[j].region.state[k].city[l].name + '<input value="' +
                    areaData[j].region.state[k].city[l].code + '" style="display:none"></a></li>';
                  break;
                case "H":
                case "I":
                case "J":
                ...
                case "M":
                case "N":
                  cityDomPartTwo += '<li><a>' + areaData[j].region.state[k].city[l].name + '<input value="' +
                    areaData[j].region.state[k].city[l].code + '" style="display:none"></a></li>';
                  break;
                case "O":
                case "P":
                ...
                case "T":
                case "U":
                  cityDomPartThree += '<li><a>' + areaData[j].region.state[k].city[l].name + '<input value="' +
                    areaData[j].region.state[k].city[l].code + '" style="display:none"></a></li>';
                  break;
                case "V":
                case "W":
                ...
                case "Y":
                case "Z":
                  cityDomPartFour += '<li><a>' + areaData[j].region.state[k].city[l].name + '<input value="' +
                    areaData[j].region.state[k].city[l].code + '" style="display:none"></a></li>';
                  break;
              }
            }
